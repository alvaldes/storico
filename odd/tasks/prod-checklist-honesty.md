...
**PR 2 — `fix/retire-trello-option-and-dead-settings`** — landed on `main` @ `61a132b` (`git merge --ff-only` `fc59dc5` → `61a132b`, pushed, branch deleted with `-d`); native review `review-bde8183340bdb47b` approved and burned; CI run `35563349443` green and backend deploy run `35563349521` green; production probed healthy afterwards.
