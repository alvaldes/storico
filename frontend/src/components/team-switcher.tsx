...
import { Building2, Plus, Check, ChevronsUpDown, SearchIcon, LoaderCircle } from 'lucide-react';
  ...
  return (
    <>
              ...
              <DropdownMenuGroup>
                ...
                {teams.map((team) => (
                  ...
                  >
                    ...
                    {team.id === activeTeam.id && <Check className="size-4 text-primary" />}
                  </DropdownMenuItem>
                ))}
              </DropdownMenuGroup>
              <DropdownMenuSeparator />
      ...
      <Dialog open={createOpen} onOpenChange={setCreateOpen}>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>{t.sidebar?.newWorkspace ?? 'New Workspace'}</DialogTitle>
            <DialogDescription>
              {t.sidebar?.createWorkspaceDescription ??
